...
export default function Cart() {
  ...
  const [deliveryPos, setDeliveryPos] = useState(user.coordinates || [12.9352, 77.6245]);
            ...
            <div className="lg:col-span-4 sticky top-32">
              <div className="glass-card rounded-[3.5rem] p-10 border border-white shadow-2xl shadow-primary/5">
                ...
                <div className="space-y-6 mb-10">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold text-slate-400 uppercase tracking-widest">Delivery Protocol</span>
                    <span className="text-sm font-black text-green-500 uppercase tracking-widest">Complementary</span>
                  </div>
                  <div className="flex justify-between items-center">
                ...
                <div className="mt-8 flex items-center justify-center gap-4 py-4 bg-slate-50/50 rounded-2xl border border-slate-100">
                  <Zap className="w-4 h-4 text-primary fill-primary" />
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Verified Transaction</p>
                </div>
              </div>
