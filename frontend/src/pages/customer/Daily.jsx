    ...
    <div className="min-h-screen bg-slate-50 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 mb-2">Daily Food</h1>
            <p className="text-slate-500">Discover chefs offering fresh daily meals in your area.</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            ...
            {search && dishes.length > 0 && (
              <div>
                <h2 className="text-2xl font-bold text-slate-800 mb-6">Dishes matching "{search}"</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {dishes.map(item => (
            ...
            {chefs.length > 0 ? (
              ...
              !dishes.length && (
                <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-slate-100">
                  ...
                  <p className="text-slate-500">We couldn't find any chefs or dishes matching "{search}".</p>
                </div>
              )
            )}
