...
export default function TrackOrder() {
  ...
  const [userPos, setUserPos] = useState(user.coordinates || [12.9352, 77.6245]);
            ...
            <div className="space-y-8">
               ...
               <div className="flex items-center gap-5">
                 ...
                 <div>
                    ...
                    <p className="text-sm font-black text-slate-800 line-clamp-1">{user?.address || user?.location || "Primary Address"}</p>
                 </div>
               </div>
            </div>
