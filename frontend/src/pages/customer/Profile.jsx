        ...
        <div className="flex justify-center mb-12">
          <div className="bg-white/60 backdrop-blur-xl p-2 rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-white flex gap-2">
            {[
              ...
              { id: "wallet", label: "Financials", icon: TrendingUp },
                      ...
                      <div className="flex items-center justify-between">
                         ...
                         {order.status === "completed" && !order.rated ? (
                            ...
                            <div className="px-4 py-2 bg-green-50 rounded-xl text-green-600 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                               <CheckCircle2 className="w-4 h-4" /> Verified Order
                            </div>
                         ) : (
            ...
            {activeView === "settings" && (
              ...
              >
                 ...
                 <div className="space-y-8">
                    ...
                    <div className="space-y-3">
                       <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">City / General Location</label>
                       <input className="w-full bg-slate-50/80 border-none rounded-2xl px-6 py-5 font-bold text-slate-800 focus:ring-2 focus:ring-primary transition-all shadow-sm" placeholder="e.g. Hyderabad" value={form?.location || ""} onChange={e => setForm({...form, location: e.target.value})} />
                    </div>
                    <div className="space-y-3">
                       <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Detailed Delivery Address</label>
                       <textarea className="w-full bg-slate-50/80 border-none rounded-2xl px-6 py-5 font-bold text-slate-800 h-32 resize-none focus:ring-2 focus:ring-primary transition-all shadow-sm" placeholder="House No, Street, Landmark..." value={form?.address || ""} onChange={e => setForm({...form, address: e.target.value})} />
                    </div>
